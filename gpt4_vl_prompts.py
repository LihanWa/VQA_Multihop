...
def create_payload_edge(image: str, prompt: str, label_sentence: str,model="gpt-4o-2024-05-13", max_tokens=200, detail="high"):
    ...
    print(prompt)
    base64_image = encode_image("/root/projects/code_lihan/threeCup.png")
    ...
    messages = [
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Thought: For the question, I only have to consider liquid marked by 4 or 5, and cup marked by 3. Since the liquid marked by 4 is not in the cup marked by 3, the liquid marked by 5 is not in the cup marked by 3. Answer: Cup [3] does not contain liquid [4,5].",
                },
            ],
        },
        {
    ...
    messages = [
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Thought: Based on the question, I only have to consider liquid marked by 4. Since the liquid marked by 4 is white. Answer: Liquid [4] is not light brown.",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Thought: Based on the question, I only have to consider liquid marked by 4 or 5. Since the liquid marked by 4 is not light brown, the liquid marked by 5 is light brown. Answer: Liquid [4] is not light brown, liquid [5] is light brown.",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Thought: For the question, I only have to consider liquid marked by 4 or 5 or 6. Since the liquid marked by 4 is not dark brown, the liquid marked by 5 is not dark brown, the liquid marked by 6 is dark brown. Answer: Liquid [4] is not dark brown, liquid [5] is not dark brown, liquid [6] is dark brown.",
                },
            ],
        },
        {
...
def compare_color(image0: str, image1: str,model="gpt-4o-2024-05-13", max_tokens=200, detail="high"):
    """Creates the payload for the API request."""
    ...
    messages = [
        {
            ...
            "content": [
                {
                    "type": "text",  
                    "text": '''AI assistant should say in which image you can see the word "Hello" more easily and obviously for GPT not for human. Say the image by the color of the "Hello"./
